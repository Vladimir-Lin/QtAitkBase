...
//////////////////////////////////////////////////////////////////////////////
qint64 N::TimeBits::sizeHint ( QDateTime startTime                           ,
                               QDateTime endTime                             ,
                               int       dt                                ) {
  qint64 rt                                                                  ;
...
//////////////////////////////////////////////////////////////////////////////
void N::TimeBits::setParameters ( QDateTime startTime                        ,
                                  QDateTime realStart                        ,
                                  QDateTime endTime                          ,
                                  int       dt                             ) {
  DateTimes [ QString::fromLatin1 ( "Start" ) ] = startTime                  ;
  DateTimes [ QString::fromLatin1 ( "Real"  ) ] = realStart                  ;
  DateTimes [ QString::fromLatin1 ( "End"   ) ] = endTime                    ;
  Interval                                      = dt                         ;
}
//////////////////////////////////////////////////////////////////////////////
...
QDateTime N::TimeBits::toDateTime ( qint64 index )                           {
  QDateTime ST = DateTimes [ QString::fromLatin1 ( "Start" ) ]               ;
  qint64 ds = index                                                          ;
  ds *= Interval                                                             ;
  ST  = ST . addSecs ( ds )                                                  ;
  return ST                                                                  ;
...
qint64 N::TimeBits::toIndex ( QDateTime time )                               {
  qint64 ds                                                                  ;
  ds  = DateTimes [ QString::fromLatin1 ( "Start" ) ] . secsTo ( time )      ;
  ds /= Interval                                                             ;
  return ds                                                                  ;
}
//////////////////////////////////////////////////////////////////////////////
